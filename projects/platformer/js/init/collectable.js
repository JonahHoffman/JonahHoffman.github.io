(function (window) {
    ...
    let type = {
        ...
        steve: {assetKey: 'steve', points: 199},
        grace: {assetKey: 'grace', points: 200},
        kennedi: {assetKey: 'kennedi', points: 0}
    };
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.kennedi, 125, 5);
        collectable.create(type.grace, 555, 400);
        collectable.create(type.steve, 700, game.world.height - 130);
